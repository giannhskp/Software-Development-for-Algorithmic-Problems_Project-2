...
Καταφέρνοντας να επαλήθευσουμε την ορθή λειτουργία των εξής συναρτήσεων:

	- discreteFrechet(...)-> μέσω της συνάρτησης test_discreteFrechet(...)
	- meanCurveBetween2Curves(...)-> μέσω της συνάρτησης test_meanCurveBetween2Curves(...)
	- computeG(...) -> μέσω της συνάρτησης test_gFunction(...)
...
Υπολογίσαμε ¨στο χαρτί", εφαρμόζοντας την συγκεκριμένη μετρική, πως η απόσταση μεταξύ των καμπυλών ειναι ίση με 1.2 .
...
Φυσικά και η αντίστοιχη συνάρτηση επιστρέφει το αναμενό αποτέλεσμα, διαβεβαιώνοντάς μας πως η υλοποίηση μας για τον υπολογισμό της Discrete Frechet Distance ειναι σωστή.
...
Φυσικά και η αντίστοιχη συνάρτηση επιστρέφει την αναμενόμενη χρονοσειρά, διαβεβαιώνοντάς μας πως η υλοποίηση μας για τον υπολογισμό της mean curve μεταξύ 2 χρονοσειρών ειναι σωστή.
...
Είναι λογικό πως η τιμή της g function, η οπόια χρησιμοποιείται ως hash function στο LSH, πρέπει να είναι η ίδια για 
