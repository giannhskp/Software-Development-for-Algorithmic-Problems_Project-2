...
CC=gcc
CCPLUSPLUS=g++ -O2 -std=c++14
CFLAGS= -g -O2 -Wall -I$(HASHTABLELIST) -I$(HASHTABLE) -I$(PARSING) -I$(VECTOR) -I$(LSH) -I$(CLUSTER) -I$(FRECHET) -I$(BINARYTREE) -I$(FRECHERCONT)

OBJ1= search.o mainLSH.o mainCube.o  $(HASHTABLE)/hashTable.o $(HASHTABLELIST)/hashTableList.o $(PARSING)/parsingLSH.o $(PARSING)/parsingCube.o $(VECTOR)/vector.o $(LSH)/lsh.o $(HYPERCUBE)/hypercube.o $(HASHMAP)/hashmap.o $(LSH)/helperFunctions.o $(FRECHET)/discreteFrechet.o $(BINARYTREE)/binaryTree.o
